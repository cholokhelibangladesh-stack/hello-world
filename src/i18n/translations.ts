...
export const translations = {
  en: {
    ...
    "footer.faqHelpline": "Contact Us",
    "footer.contact": "CONTACT",
    "footer.dhaka": "Dhaka, Bangladesh",
    "footer.followJourney": "Follow the Journey",
    "footer.copyright": "© 2026 Cholo Kheli",

    // Contact Us page
    "contact.title": "CONTACT US",
    "contact.faqHeading": "Frequently Asked Questions",
    "contact.searchPh": "Search questions...",
    "contact.noResults": "No matching questions found.",
    "contact.formHeading": "SEND US A MESSAGE",
    "contact.formSub": "Have a question, suggestion or concern? Fill in the form below and our admin team will get back to you by email.",
    ...
    "contact.success": "Thanks! Your message has been sent to our team.",
    "contact.error": "Something went wrong. Please try again.",
    "contact.urgentHeading": "NEED URGENT HELP?",
    "contact.urgentBody": "If you feel unsafe or need immediate assistance, report it now.",
    "contact.reportBtn": "Report a Scout",
    "contact.reportSent": "Report Sent",
    "contact.reportSentDesc": "Admin has been alerted immediately.",
  ...
  bn: {
    ...
    "footer.faqHelpline": "যোগাযোগ",
    "footer.contact": "যোগাযোগ",
    "footer.dhaka": "ঢাকা, বাংলাদেশ",
    "footer.followJourney": "যাত্রা অনুসরণ করুন",
    "footer.copyright": "© ২০২৬ চলো খেলি",

    // Contact Us page
    "contact.title": "যোগাযোগ করুন",
    "contact.faqHeading": "সচরাচর জিজ্ঞাসিত প্রশ্ন",
    "contact.searchPh": "প্রশ্ন খুঁজুন...",
    "contact.noResults": "কোনো মিলে যাওয়া প্রশ্ন পাওয়া যায়নি।",
    "contact.formHeading": "আমাদের বার্তা পাঠান",
    "contact.formSub": "কোনো প্রশ্ন, পরামর্শ বা উদ্বেগ আছে? নিচের ফর্মটি পূরণ করুন — আমাদের অ্যাডমিন দল ইমেইলে উত্তর দেবে।",
    "contact.name": "আপনার নাম",
    "contact.namePh": "পূর্ণ নাম",
    "contact.email": "আপনার ইমেইল",
    "contact.emailPh": "you@example.com",
    "contact.subject": "বিষয়",
    "contact.subjectPh": "কী বিষয়ে?",
    "contact.message": "বার্তা",
    "contact.messagePh": "আপনার বার্তা লিখুন...",
    "contact.send": "বার্তা পাঠান",
    "contact.sending": "পাঠানো হচ্ছে...",
    "contact.success": "ধন্যবাদ! আপনার বার্তা আমাদের দলের কাছে পৌঁছেছে।",
    "contact.error": "কিছু ভুল হয়েছে। আবার চেষ্টা করুন।",
    "contact.urgentHeading": "জরুরি সাহায্য দরকার?",
    "contact.urgentBody": "নিরাপদ না অনুভব করলে বা তাৎক্ষণিক সহায়তা প্রয়োজন হলে এখনই জানান।",
    "contact.reportBtn": "একজন স্কাউট রিপোর্ট করুন",
    "contact.reportSent": "রিপোর্ট পাঠানো হয়েছে",
    "contact.reportSentDesc": "অ্যাডমিনকে তাৎক্ষণিকভাবে জানানো হয়েছে।",
